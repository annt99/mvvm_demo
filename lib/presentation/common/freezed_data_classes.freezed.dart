...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.name, this.email, this.numberPhone, this.countryCode,
      this.password, this.pictureLink);
  ...
  @override
  String toString() {
    return 'RegisterObject(name: $name, email: $email, numberPhone: $numberPhone, countryCode: $countryCode, password: $password, pictureLink: $pictureLink)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, email, numberPhone,
      countryCode, password, pictureLink);
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(
      ...
      final String countryCode,
      final String password,
      final String pictureLink) = _$_RegisterObject;
